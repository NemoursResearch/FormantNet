...
# 
# ### Execution:
# This script was run with three command-line parameters that indicate the number of formants and antiformants, and whether the model should be monodirectional or bidirectional. The output (consisting of data statistics, model specifications, and script progress reports, including training and validation loss) is saved to an output file, e.g.:
# 
